...
```{r}
# I can't seem to figure this one out, none of the ones I tried to parallelize worked faster than serial.
...
```{r}
# app2 contains all of this data
```
