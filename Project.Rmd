...
# ggplot(title_basics, aes(x = titleType, y = runtimeMinutes, fill = isAdult)) +
#   geom_boxplot(outlier.alpha = 0.2) +
#   geom_jitter(aes(color = isAdult), width = 0.2, alpha = 0.2) +
#   facet_wrap(~ genres, scales = "free_y") +
#   coord_flip() +
#   labs(
#     title = "Runtime by Title Type and Genre",
#     x = "Title Type",
#     y = "Runtime (minutes)",
#     fill = "Adult",
#     color = "Adult"
...
# # Plot for title_ratings using stat_summary and annotations
# ggplot(title_ratings, aes(x = averageRating, y = numVotes)) +
#   geom_point(aes(color = rating_group), alpha = 0.3) +
...
#     subtitle = "Points, LOESS smooth, and binned mean",
#     x = "Average Rating",
#     y = "Number of Votes (log scale)",
#     color = "Rating Group"
#   ) +
#   annotate("text", x = 8, y = 1e6, label = "Highly rated & popular", color = "blue") +
#   theme_minimal()
```
